...
\resumeItem{Involved in the development of a new Tizen OS systems software
	written in \CC.}
...
\resumeItem{Worked remotely with a medium-sized team from various
	nationalities (USA, Taiwan, and Indonesia).}
\resumeItemListEnd
